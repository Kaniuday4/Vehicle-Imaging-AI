...
ap.add_argument("-p","--pbtxt",default="model_old/graph.pbtxt",help="pbtxt file")
ap.add_argument("-m","--model",default="model_old/frozen_inference_graph.pb",help="model file().pb")
